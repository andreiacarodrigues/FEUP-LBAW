                                    ...
                                    <div class="container">
                                        <div class="col-md-10">
                                            <ul class="list-unstyled">
                                                ...
                                                <li><label><i class="fa fa-chevron-right" aria-hidden="true"></i> Sports Complex Contact: <span> {$RENTAL.complexPhone} </span></label>
                                                </li>
                                                <li><label><i class="fa fa-chevron-right" aria-hidden="true"></i> Sports Complex Email: <span> {$RENTAL.complexEmail} </span></label>
                                                </li>
                                                ...
                                                <li><label><i class="fa fa-chevron-right" aria-hidden="true"></i>
                                                        Duration: <span> {$RENTAL.rentalDuration} </span></label></li>
                                                <li><label><i class="fa fa-chevron-right" aria-hidden="true"></i>
                                                        Equipment: <span>  {$RENTAL.equipment} </span></label></li>
                                                ...
                                                && ($RENTAL.rentalState != "CANCELEDBYMANAGER") && ($RENTAL.rentalState != "CANCELEDBYADMIN")}
                                                    {if $RENTAL.rentalState != "SUSPENDEDBYADMIN"}
                                                        <form class="tr equipmentForm"
                                                            ...
                                                            <button type="submit"
                                                                    class="btn btn-primary gradient-yellow">
                                                                Suspend
                                                            </button>
                                                        </form>
                                                    {/if}
                                                    <form class="tr equipmentForm"
                                                        ...
                                                        <button type="submit" class="btn btn-primary gradient-red">
                                                            Cancel
