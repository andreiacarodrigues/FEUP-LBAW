...
<div class="manageComplexes">
    <div class="container">
        ...
        <div class="row">
            <a href="{$BASE_URL}pages/managers/addComplex.php" class="addComplexBtn btn btn-primary gradient-red">Add
                Complex <i class="fa fa-plus-circle" aria-hidden="true"></i></a>
            <hr>
        </div>
        {if count($COMPLEXES) == 0}
        <h4> You aren't manager of any sport complexes yet. <br><br> If you have your own sport complex business,
            you can add it to
            our website in the button above, so you can register spaces and equipment other users can rent at a
            specific time and date. <br><br>
            You will have the resources to manage the complex items, rentals, issues and reviews other users may
            leave after a rental and the
