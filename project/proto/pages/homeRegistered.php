...
?>
    ...
    <div class="intro-header">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="searchForm" action="users/searchResults.php" method="post" autocomplete="on">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-md-offset-2" id="scrollable">
                                ...
                                <div class="row">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <h4> Complex 1 ⭐⭐⭐⭐</h4>
                                        <a class="btn btn-primary btn-sm gradient-blue" href="users/sportComplex.php">Check<span class="glyphicon glyphicon-chevron-right"></span></a>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h5> Complex 1 ⭐⭐⭐⭐</h5>
                                        <a class="btn btn-primary btn-sm gradient-blue" href="users/sportComplex.php">Check Complex<span class="glyphicon glyphicon-chevron-right"></span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
